...
import Index from '../ChooseSubscription';
    ...
    async function signUpWithEmail() {
        ...
        if (user) {
            ...
            const { error: insertError } = await supabase
                ...
                .insert([
                    {
                        id: user.id, // Use the user's ID from the auth table
                        name: name,
                        email: email,
                        promoCode: promoCode,
                        profile_photo: ''
    ...
    return (
        <View
            ...
            <Text style={{
                ...
                color: '#000',
                opacity: 0.8,
            }}>{'Enter your details for sign up.'}</Text>

            <View style={{ alignSelf: 'center', marginVertical: 30 }}>
                <Image style={{ width: 100, height: 100, resizeMode: 'contain' }} source={AppImages.signup_image_ph} />
                <TouchableOpacity><Image
                    style={{ width: 28, height: 28, resizeMode: 'contain', position: 'absolute', bottom: 0, right: 5 }}
                    source={AppImages.plus_icon} /></TouchableOpacity>
            </View>
            ...
            <ScrollView>
                ...
                <View style={{
                    ...
                    <TouchableOpacity style={{
                        backgroundColor: isTermsAccepted ? colors.black : colors.white,
