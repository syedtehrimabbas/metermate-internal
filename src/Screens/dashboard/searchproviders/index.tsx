        ...
        <View
          ...
          <Text
            ...
            <Text
              ...
              {String(filteredProviders.length).padStart(2, '0')}
            </Text>
          </Text>
        </View>
        <FlatList
...
const SearchElectricProviders = ({navigation}) => {
  ...
  const handleZipcodeSelect = async zipcode => {
    ...
    if (lastSelectedZipcode !== zipcode.zipcode) {
      ...
      console.log(
        'Selected zipcode is the same as the last one. No action taken.',
      );
    }
  };
